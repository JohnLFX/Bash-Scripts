...
echo "99be79935354f5c0df1ad293620ea36d13f48ec3ea870c838f20c504c9668b57  openjdk-11.0.2_linux-x64_bin.tar.gz" | sha1sum --check
echo "Extracting..."
tar -xzf community_images.tar.gz -C /opt/jdk
echo "Cleaning..."
